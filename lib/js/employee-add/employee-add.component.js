		...
		controller: ['$http', 'EmployeeService',
			function EmployeeAddController($http, EmployeeService) {
				...
				self.save = function save() {
					...
					self.employee['first_level_reporting_set'] = self.employee.first_level_reporting;
					self.employee['second_level_reporting_set'] = self.employee.second_level_reporting;
					var req = {
						method: 'POST',
